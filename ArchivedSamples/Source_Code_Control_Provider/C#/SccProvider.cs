...
namespace Microsoft.Samples.VisualStudio.SourceControlIntegration.SccProvider
{
        ...
        IVsPersistSolutionProps    // We'll write properties in the solution file to track when solution is controlled; the interface needs to be implemented by the package object
    {
        ...
        /// <summary>
        /// Error handling for when a project fails to load. Currently does nothing
        /// </summary>
        /// <returns>Returns S_OK. Add your own error handling here</returns>
        ...
        /// <summary>
        /// Called by the IDE to determine if something needs to be saved in the solution. If the package returns that it has
        /// dirty properties, the shell will callback on SaveSolutionProps
        /// </summary>
        ...
        /// <summary>
        /// Called by the shell after determining the package has dirty props. The package will pass in the key under which it 
        /// wants to save its properties, and the IDE will call back on WriteSolutionProps
        /// </summary>
